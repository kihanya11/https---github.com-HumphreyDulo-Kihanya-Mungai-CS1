...
public function add_product()
{
    ...
    // Store the product data in the database with a 'pending' status
    $productData = [
        'vendorid' => $userId,
        ...
        'approval' => 'pending' // Set the status as 'pending'
    ];
    $productModel->insert($productData);

    // Provide success message and redirect back to the vendor dashboard
    return redirect()->to('Post')->with('success_message', 'Product added successfully. It will be visible after admin approval.');
}
